...
variable "settings" {
  description = "Configuration settings for the CDN Front Door Origin Group."
  type        = any
}
...
variable "remote_objects" {
  description = "Remote objects that may be referenced by this module, such as diagnostics."
  type        = any
}